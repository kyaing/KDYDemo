...
@property (nonatomic, strong) NSString *profileImageURL; ///< 头像 50x50 (FeedList)
@property (nonatomic, strong) NSString *avatarLarge;     ///< 头像 180*180
@property (nonatomic, strong) NSString *avatarHD;        ///< 头像 原图
@property (nonatomic, strong) NSString *coverImage;      ///< 封面图 920x300
...
@property (nonatomic, strong) NSString *pagePic; ///< 图片URL，不需要加(_default) 通常是左侧的方形图片
@property (nonatomic, strong) NSString *typeIcon; ///< Badge 图片URL，不需要加(_default) 通常放在最左上角角落里
...
@property (nonatomic, strong) NSString *createdAt; ///< 发布时间
...
@property (nonatomic, strong) NSString *bmiddlePic; ///< 中图
@property (nonatomic, strong) NSString *originalPic; ///< 大图
...
@interface WBEmotionGroup : NSObject
...
@property (nonatomic, assign) WBEmotionType type;
@property (nonatomic, weak) WBEmotionGroup *group;
@end
