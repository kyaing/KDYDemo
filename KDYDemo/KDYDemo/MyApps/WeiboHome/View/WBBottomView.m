...
- (void)setupViews {
    ...
    _topBG.backgroundColor=RGB(216, 216, 216);
    [self addSubview:_topBG];
    
    _imageBG=[[UIImageView alloc]init];
    _imageBG.backgroundColor=[UIColor clearColor];
    _imageBG.image=[UIImage imageNamed:@"common_card_bottom_background"];
    ...
    _oneLine.backgroundColor=[UIColor clearColor];
    ...
    _twoLine.backgroundColor=[UIColor clearColor];
...
- (void)setupFrames {
    _topBG.frame=CGRectMake(0,0,kScreenWidth,1.0f/[UIScreen mainScreen].scale);
    _imageBG.frame=CGRectMake(0,1.0f/[UIScreen mainScreen].scale,kScreenWidth,36);
    _btnForwarding.frame=CGRectMake(0,0,kScreenWidth/3,36);
    _oneLine.frame=CGRectMake(kScreenWidth/3,0,1,36);
    _btnComments.frame=CGRectMake(kScreenWidth/3+1,0,102,36);
    _twoLine.frame=CGRectMake((kScreenWidth/3)*2,0,1,36);
    _btnPraise.frame=CGRectMake((kScreenWidth/3)*2+1,0,102,36);
}
