//
//  KDComressionViewController.m
//  KDYDemo
//
//  Created by kaideyi on 16/2/21.
//  Copyright © 2016年 kaideyi.com. All rights reserved.
//

/**
 *  有个疑问了：哪些控件是要设置对应的约束优先级？
 */

#import "KDComressionViewController.h"

static CGFloat const margin = 10;
static NSString * const redLabelString = @"名字";
...
@interface KDComressionViewController ()
...
@implementation KDComressionViewController

- (void)viewDidLoad {
    [super viewDidLoad];

    self.title = @"CompressionResistance";
...
- (void)setupViews {
    ...
    [self.nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.avatarImageView).offset(margin);
    }];
